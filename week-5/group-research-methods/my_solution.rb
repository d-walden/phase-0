...
sort array as though all elements were strings
=end
...
# The sort_by method sorts the array by the results of each of the block calls. sort and sort_by are very similar when it comes to arrays. For example,
# source.sort_by { |a| a.to_s }
## could also be written
# source.sort { |a, b| a.to_s <=> b.to_s }

# Anytime you call sort or sort_by on a hash, you get back an array.
#
# sort_by is useful when dealing with more complex hashes because it allows you to specify nested attributes when defining how you want your hash to be sorted.

# sort_by is more efficient than sort, especially when working with larger arrays.
